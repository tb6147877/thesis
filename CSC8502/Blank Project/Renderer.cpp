...
Renderer::Renderer(Window &parent) : OGLRenderer(parent)	{
	...
	//m_nft = new NFT_Print_Excutor(1024, 1024, "NFT_SimpleVert.glsl", "NFT_SimpleFrag.glsl");
...
void Renderer::RenderScene()	{
	...
	case Renderer::Forward:
		//0.Forward Rendering
		DepthPrePass(m_isMsaa);
		ForwardRendering(m_isMsaa);
		break;
	case Renderer::Deferred:
...
void Renderer::InitForwardPlusRendering() {
	...
	size_t numberOfTiles = m_workGroupsX * m_workGroupsY;//13430=158*85
